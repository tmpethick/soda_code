...
# -----------------------------------------------------------------------------
# Unconstrained Scion (uScion) optimizer
...
class uScion(torch.optim.Optimizer):
    def __init__(self, params, lr=1e-3, momentum=1.0, norm: str='Spectral', norm_kwargs: dict=None):
        if lr < 0.0:
...
class Hyperparameters:
    ...
    wandb_run_name : str = "SODA(uScion)"
    n_layer : int = 12
...
optimizer1 = uScion(optim_groups, momentum=args.momentum)
optimizer1 = SODAWrapper(optimizer1)
