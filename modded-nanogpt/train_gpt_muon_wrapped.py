...
zeropower_backends = dict(svd=zeroth_power_via_svd, newtonschulz5=zeropower_via_newtonschulz5)
...
optimizer1 = torch.optim.AdamW(raw_model.lm_head.parameters(), lr=10*args.learning_rate, betas=(0.9, 0.95),
                            weight_decay=0, fused=True)
optimizer2 = Muon(raw_model.transformer.h.parameters(), lr=args.learning_rate, momentum=0.95,
                rank=ddp_rank, world_size=ddp_world_size)
# optimizer1, optimizer2 = SODAWrapper(optimizer1), SODAWrapper(optimizer2)
optimizer1, optimizer2 = optimizer1, SODAWrapper(optimizer2)
